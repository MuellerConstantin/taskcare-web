...
export default function BoardRemoveDialog({
  show,
  onRemove,
  onClose,
  boardIds,
    ...
    <Modal size="md" show={show} onClose={onClose}>
      ...
      <Modal.Body className="flex flex-col space-y-4 text-gray-900 dark:text-white">
        ...
        <p className="text-xs">
          ...
          {boardIds.length > 1 ? "These boards" : "This board"} will be
          permanently deleted all its resources and their data will be lost.
        </p>
      </Modal.Body>
