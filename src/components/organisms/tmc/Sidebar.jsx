...
export default function Sidebar() {
  ...
  const navigation = useMemo(() => {
    return {
      "content": [
        { name: "Boards", icon: mdiViewDashboardVariant, path: "/tmc/boards", isCurrent: pathname === "/tmc/boards" },
      ],
      "system": [
        { name: "Users", icon: mdiAccountGroup, path: "/tmc/users", isCurrent: pathname === "/tmc/users" },
      ],
    };
  }, [pathname]);
  ...
  return (
    <FlowbiteSidebar theme={customSidebarTheme}>
      ...
      <FlowbiteSidebar.Items>
        ...
        <FlowbiteSidebar.ItemGroup>
          <div className="text-sm px-3 font-semibold text-gray-900 dark:text-white">System Management</div>
