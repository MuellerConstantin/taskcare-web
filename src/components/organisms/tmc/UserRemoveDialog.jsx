  ...
  return (
    <Modal size="md" show={show} onClose={onClose}>
      ...
      <Modal.Body className="space-y-4 flex flex-col text-gray-900 dark:text-white">
        ...
        <p className="text-xs">
          This action cannot be undone. {userIds.length > 1 ? "These users" : "This user"} will
          be permanently deleted all its resources and their data will be lost or transfered
          to another users.
        </p>
      </Modal.Body>
