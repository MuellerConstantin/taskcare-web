...
const meta: Meta<typeof BoardNavbar> = {
  title: "Organisms/Board/BoardNavbar",
  component: BoardNavbar,
};

export default meta;

export const Default: StoryObj<typeof BoardNavbar> = {
  args: {},
  parameters: {
    nextjs: {
      appDirectory: true,
...
export const MissingPermissions: StoryObj<typeof BoardNavbar> = {
  args: {},
  parameters: {
    nextjs: {
      appDirectory: true,
...
export const BoardErrored: StoryObj<typeof BoardNavbar> = {
  args: {},
  parameters: {
    nextjs: {
      appDirectory: true,
      navigation: {
        pathname: `/boards/${BOARD_ERROR_ID}`,
        segments: [["boardId", BOARD_ERROR_ID]],
      },
    },
    msw: {
      handlers: [
...
export const MemberErrored: StoryObj<typeof BoardNavbar> = {
  args: {},
  parameters: {
    nextjs: {
      appDirectory: true,
    ...
    msw: {
      handlers: [
        ...
        http.get("/api/proxy/boards/:boardId/members", async () => {
          return new HttpResponse(null, {
            status: 404,
          });
        }),
