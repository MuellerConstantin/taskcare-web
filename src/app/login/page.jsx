...
export default function Login() {
  ...
  return (
    <div
      className="grow flex items-center justify-center lg:justify-end px-4 py-12 lg:px-0 lg:py-0 overflow-hidden min-h-screen"
      style={{
    ...
    >
      <div
        className="w-full max-w-lg lg:max-w-[33%] lg:min-h-screen rounded-md lg:rounded-none opacity-95 bg-white dark:bg-gray-800 shadow text-gray-800 dark:text-white p-8 flex flex-col lg:justify-center backdrop-blur-lg"
      >
        <div className="space-y-6 w-full max-w-lg 2xl:max-w-2xl mx-auto">
          <div className="flex flex-col space-y-4">
            <div className="flex space-x-6 justify-center items-center">
              ...
              />
              <h1 className="text-center lg:text-3xl text-2xl lg:text-4xl 2xl:text-6xl font-bold">
                TaskCare
              </h1>
            </div>
          ...
          {!loading && !error && searchParams.get("logout") === "true" && (
            <p className="text-center text-amber-500 2xl:text-lg">You have been logged out</p>
          )}
          {error && (
